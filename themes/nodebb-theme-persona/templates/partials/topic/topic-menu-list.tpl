...
<li <!-- IF resolved -->hidden<!-- ENDIF resolved -->><a component="topic/resolve" href="#" class="<!-- IF resolved -->hidden<!-- ENDIF resolved -->"><i class="fa fa-fw fa-check"></i> Resolve Topic</a></li>
<li <!-- IF !resolved -->hidden<!-- ENDIF !resolved -->><a component="topic/unresolve" href="#" class="<!-- IF !resolved -->hidden<!-- ENDIF !resolved -->"><i class="fa fa-fw fa-times"></i> Unresolve Topic</a></li>
{{{ end }}}
