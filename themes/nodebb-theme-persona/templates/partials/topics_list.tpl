    ...
    <li component="category/topic" class="row clearfix category-item {function.generateTopicClass}" <!-- IMPORT partials/data/category.tpl -->>
        ...
        <div class="col-md-6 col-sm-9 col-xs-10 content">
            ...
            <h2 component="topic/header" class="title">
                ...
                <i component="topic/resolved" class="fa fa-check <!-- IF !topics.resolved -->hide<!-- ENDIF !topics.resolved -->" title="[[topic:resolved]]"></i>
                <i component="topic/unresolved" class="fa fa-times <!-- IF topics.resolved -->hide<!-- ENDIF topics.resolved -->" title="[[topic:unresolved]]"></i>
