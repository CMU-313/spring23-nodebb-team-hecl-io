            ...
            <h1 component="post/header" class="" itemprop="name">
                <span class="topic-title">
                    <span component="topic/labels">
                        ...
                        <i component="topic/resolved" class="fa fa-check <!-- IF !resolved -->hidden<!-- ENDIF !resolved -->" title="Resolved"> (Resolved) </i>
                        <i component="topic/unresolved" class="fa fa-times <!-- IF resolved -->hidden<!-- ENDIF resolved -->" title="Unresolved"> (Unresolved) </i>
