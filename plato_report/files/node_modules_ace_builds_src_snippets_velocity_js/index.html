...
<head>
  <meta charset="utf-8">
  <title>Plato - node_modules/ace-builds/src/snippets/velocity.js</title>
...
<div class="jumbotron">
  <div class="container">
    <h1>node_modules/ace-builds/src/snippets/velocity.js</h1>
  </div>
</div>
...
<div class="container">
  <div class="row">
    <textarea id="file-source" class="col-md-12">define(&quot;ace/snippets/velocity.snippets&quot;,[&quot;require&quot;,&quot;exports&quot;,&quot;module&quot;], function(require, exports, module){module.exports = &quot;# macro\nsnippet #macro\n\t#macro ( ${1:macroName} ${2:\\$var1, [\\$var2, ...]} )\n\t\t${3:## macro code}\n\t#end\n# foreach\nsnippet #foreach\n\t#foreach ( ${1:\\$item} in ${2:\\$collection} )\n\t\t${3:## foreach code}\n\t#end\n# if\nsnippet #if\n\t#if ( ${1:true} )\n\t\t${0}\n\t#end\n# if ... else\nsnippet #ife\n\t#if ( ${1:true} )\n\t\t${2}\n\t#else\n\t\t${0}\n\t#end\n#import\nsnippet #import\n\t#import ( \&quot;${1:path/to/velocity/format}\&quot; )\n# set\nsnippet #set\n\t#set ( $${1:var} = ${0} )\n&quot;;
