...
<head>
  <meta charset="utf-8">
  <title>Plato - node_modules/@webassemblyjs/ast/esm/signatures.js</title>
...
<div class="jumbotron">
  <div class="container">
    <h1>node_modules/@webassemblyjs/ast/esm/signatures.js</h1>
  </div>
</div>
...
<div class="container">
  <div class="row">
    <textarea id="file-source" class="col-md-12">function sign(input, output) {
  return [input, output];
}
...
export var signatures = Object.assign({}, controlInstructions, parametricInstructions, variableInstructions, memoryInstructions, numericInstructions);</textarea>
  </div>
</div>
